...
import { Category, User, UserFile } from "@/types/CommonTypes";
...
const AddNewWorker = ({ users_list }: { users_list: User[] }) => {
	const router = useRouter();
	const { user } = useAppSelector((state) => state.auth);

	// login mutation hook
	const [addWorker, { data, isLoading, isError, error, isSuccess }] =

...
import SwitchBox from "@/components/ui/FormFileds/Switch";
...
const AdminSignIn = ({ redirect_path = "/" }) => {
	...
	return (
		<div className="  p-4 pb-6 max-w-md w-full min-h-[200px] bg-white  shadow-md  ">
			...
			<div className="flex items-center justify-center flex-wrap gap-2 mt-4 ">
				<SwitchBox
					title="	Log in as a Administrator"
					component_styles="flex flex-row items-center justify-center  gap-2"
					current_value={
						signInFormState.role ==
						UserRole.SUPER_ADMIN
					}
					set_new_value={(value: boolean) => {
						setSignInForm((prev) => ({
							...prev,
							role: value
								? UserRole.SUPER_ADMIN

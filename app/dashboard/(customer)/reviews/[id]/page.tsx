...
import CreateReviewOnService from "@/components/PagesComponents/Reviews/CreateReviewOnService";
...
const CreateReview = ({ params }: { params: { id: string } }) => {
	...
	return (
		<div className=" min-h-screen w-full h-full">
			...
			{/* Body */}
			<div className=" mt-10">
				<CreateReviewOnService appointmentID={params?.id} />
			</div>
		</div>
	);
};
